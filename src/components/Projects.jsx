...
import AvatarImage1 from '../assets/avatarimg1.jpg'
import AvatarImage2 from '../assets/avatarimg2.jpg'
...
function Projects() {
  return (
    <YourProjects>
      <Project>
        <Avatar>
          <img src={AvatarImage1} alt='image1' />
        </Avatar>
        <Detail>
      ...
      <Project>
        <Avatar>
          <img src={AvatarImage2} alt='image1' />
        </Avatar>
        <Detail>
